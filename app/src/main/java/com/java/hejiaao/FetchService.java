...
public class FetchService extends Service {
    ...
    public FetchService() {
    	...
    	if (history.getCategory("shown_c").size() + history.getCategory("hidden_c").size() == 0) {
			...
			history.addCategory("hidden_c", "http://stock1.finance.qq.com/stock/dpfx/rss_dpfx.xml", "证券频道");
			...
			history.addCategory("hidden_c", "http://auto.qq.com/comment/zjpc/rss_zjpc.xml", "汽车频道");
			history.addCategory("shown_c", "http://sports.qq.com/rss_newssports.xml", "体育频道");
			history.addCategory("hidden_c", "http://games.qq.com/ntgame/rss_ntgame.xml", "游戏频道");
			history.addCategory("shown_c", "http://edu.qq.com/gaokao/rss_gaokao.xml", "教育频道");
			history.addCategory("hidden_c", "http://bb.qq.com/original/rss_original.xml", "视频频道");
			history.addCategory("hidden_c", "http://book.qq.com/origin/rss_origin.xml", "读书频道");
			history.addCategory("hidden_c", "http://lady.qq.com/qqstar/rss_qqstart.xml", "女性频道");
